...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,0);
  Lcd_string(&lcd, "PRIDEESH M\n");
  Lcd_cursor(&lcd, 1,2);
  Lcd_string(&lcd, "212223040154");
  HAL_Delay(500);
  while(1){}
}
void SystemClock_Config(void)
...
## Output screen shots of proteus  :
 ...
 ![image](https://github.com/prideeshm/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/144870483/0a733ee8-98d3-4264-a390-51c086fc0b2f)
